...
int main()
{
    ...
    while (1)
    {
                    ...
                    case 2:
                        ...
                        cout << student[count].year << endl
                            ...
                            cin>>choice5;
                             switch(choice5)
                             {
                                case 1: cout<<"submitted successfully"<<endl;
                                case 2: cout<<"what you want to edit"<<endl;
                                string edit;
                                cin>>edit;
                                if(edit=="name")
                                {
        ...
        case 2:
            ...
            {
                if (idcheck == student[count].id)
                {
                    cout << "your name is " << student[count].name << endl;
                    cout << "your father's name is " << student[count].fname << endl;
                    cout << "your branch is " << student[count].branch << endl;
                    cout << "your year is " << student[count].year << endl;
                    cout << "your room no. is " << student[count].room_no << endl;
                    cout << "your address is " << student[count].address << endl;
                }
            }
            break;
        case 3:
